...
The site's big serif headings are in Chinese too. Google Fonts doesn't load in
mainland China and a full Chinese font is ~10 MB, so we ship only the
characters the serif text on site.html actually uses, cut from Noto Serif
