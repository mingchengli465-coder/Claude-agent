...
# the same pitch every day. The same two offers as the X posts and the website.
DOMAINS = [
    "小店 AI 客服搭建",
    "帮你装好 Claude Code",
    "网站右下角的 AI 客服",
...
DEFAULT_SERVICE_BRIEF = """我是在校大学生，个人接单，自己每天都在用 Claude Code、Codex 做项目。
我搭了一个个人网站，网站右下角就挂着我做的 AI 客服，24 小时在线；想看效果，私信我要网站地址，直接跟它聊。

一、帮小店搭 AI 客服
- 按你自己的价目表和常见问题回答客人，中文、英文等多种语言都能聊，会主动问清客人要什么
- 新客人来问、客人有购买意向、准备下单付款时，第一时间通知你，附上聊天记录；回复通知就能直接跟客人说话
- 要下单付款、砍价、它答不了的问题，转给你本人，不乱答、不乱承诺
- 可以接到 Telegram、WhatsApp 等聊天平台（国内常用的平台也能接，私信细聊），也可以放进你自己的网站（网页右下角一个聊天窗口）
- 价格：国内商户一次性搭建 200 元，之后每月 49 元；海外商户一次性搭建 70-85 美元，之后每月 9.9 美元。
  月费包含服务器、AI 用量、价目表和常见问题的更新，按月付，随时可以停
- 资料给齐后 2-3 天上线

二、帮你装好 Claude Code / Codex
- 远程屏幕共享，在你自己的电脑上装好、配好、跑通，再带你用它做完第一个小任务，常见报错一起讲清楚
- Windows、Mac 都可以，一小时左右搞定
- 价格：装一个 99 元，Claude Code 和 Codex 两个一起装 149 元
- 为什么找我：官方文档是英文的，命令行对新手不友好，报错看不懂；我用中文一步一步带你
- 账号需要你自己按官方条款注册和付费，我不卖账号、不代充值、不代注册

三、其他：写代码、做 PPT、做简单网站、写文案也能接。
不接：作业代写、论文代写、代考。"""
...
1. 不攻击、不贬低任何群体，也不贬低同行（不写"别家都是套模板"之类）。
   提到豆包、千问或其他客服工具时要客观，不说它们"垃圾""没用"，不编造测评、跑分或对比数据
   （广告法禁止贬低其他商品）。
2. 不编造：不写接单数量、好评、客户原话、成交金额、"已帮 XX 人"、通过率、排名等任何无法证实的数字和案例。
   痛点场景用"你""很多人"的写法描述，不要写成某个具体客户的真实故事。
   关于服务本身，只能写【服务信息】里有的内容；价格、时效照【服务信息】原样写，不能自己加、改或打折。
3. 不写、不暗示作业代写、论文代写、代考、代课；不承诺成绩、答辩通过、面试录用。
4. 不写任何站外联系方式或平台：微信、QQ、手机号、闲鱼、淘宝、链接、网址、二维码、"加V""滴滴我"等都不行。
   引导只用"评论区留言"或"私信"；想看网站就说"私信我要网站地址"，不能直接写网址。
...
【选题要求】
从一个具体的人和痛点切入，要具体到一个场景，不要空喊"专业靠谱"。比如：
- 小店老板：晚上刚收拾完店，客人来问价格，想着明早再回，人已经去别家了；一个人撑店，没法一直盯手机；
  海外客人用英文问，不知道怎么回
- 想用 Claude Code / Codex 的人：官方文档是英文的，命令行一片黑，照着教程装到一半报错就卡住
...
- 正文：300-600 字，第一人称（"我"就是接单的人），口语化，多分段
  ...
  2）我能怎么帮你解决：只用【服务信息】里跟【{domain}】相关的那部分，讲清楚具体怎么做到
  3）把价格和多久能好说清楚（照【服务信息】原样写）
  4）送 1 条跟【{domain}】有关的实用小建议，让不下单的人也有收获
  5）结尾一句轻引导，比如"想看效果，评论区留言或私信我要网站地址，直接跟 AI 客服聊两句"
- 话题标签：6-8 个，不要带 # 号
- 封面文案：主标 2 行（每行 6-10 字，短促有力）、
  痛点问句 1 句（15 字以内）、小字 3 行（每行 8-14 字，写服务范围、价格或亮点）
...
EXAMPLE_NOTE = {
    "topic": "小店老板半夜来不及回消息，客人问完价格就去了别家",
    "title": "小店老板，别再半夜回消息了",
    "body": (
        "开小店的你，是不是也这样：晚上 11 点刚收拾完，手机弹出一条「这个多少钱？」，"
        "你想着明早再回，第二天一看，人已经去别家买了。\n\n"
        "不是客人不想买，是等不及。一个人撑店，上货、打包、招呼客人，根本没法一直盯着手机。\n\n"
        "所以我给小店做了一个 AI 客服。你把价目表和常见问题发我，它就按你的资料回答："
        "问价格、问多久能好、问怎么买，它都马上回，中文、英文都能聊，还会主动问清客人要什么。\n\n"
        "它不会乱答。要砍价的、要下单付款的、它答不了的，都会转给你本人。"
        "客人一有购买意向，你手机上就收到通知，附上聊天记录，直接回复就能接着跟客人聊。\n\n"
        "价格说清楚：国内小店一次性搭建 200 元，之后每月 49 元，包含服务器、AI 用量和价目表更新，"
        "按月付，随时可以停。资料给齐后 2-3 天上线，可以接到 Telegram 等聊天平台，也可以放进你自己的网站。\n\n"
        "送一个小建议：把客人最常问的 5 个问题写成固定回复，就算不用 AI，也能少回一半消息。\n\n"
        "我自己的网站右下角就挂着这个 AI 客服。想看效果，评论区留言或私信我要网站地址，直接跟它聊两句就知道了。"
    ),
    "tags": ["AI客服", "小店经营", "开店日记", "实体店", "AI工具", "副业", "私域运营"],
    "cover": {
        "main": ["半夜来客问价", "AI替你秒回"],
        "question": "客人问完价格就没下文？",
        "small": ["按你的价目表自动回", "想买时第一时间通知你", "搭建200元月费49"],
    },
}
