...
DEFAULT_SERVICE_BRIEF = """我是在校大学生，个人接单，用 AI 提效，交付前自己逐页检查。
能做：
...
4. 不写任何站外联系方式或平台：微信、QQ、手机号、闲鱼、淘宝、链接、二维码、"加V""滴滴我"等都不行。
   引导只用"评论区留言"或"私信"。
5. 不点名任何 AI 产品或公司（ChatGPT、Claude、Kimi、豆包等），需要时只说"AI"。
...
- 正文：300-600 字，第一人称（"我"就是接单的人），口语化，多分段
  （每段 1-3 句，段与段之间空一行）。按这个顺序写：
  1）用"你"描述一个痛点场景
  2）我能帮你做什么、怎么交付（只用【服务信息】里的内容）
  3）给 2-3 条跟【{domain}】有关的实用小建议，让不下单的人也有收获
  4）结尾一句轻引导，比如"需要的评论区留言或私信我"
- 话题标签：6-8 个，不要带 # 号
...
EXAMPLE_NOTE = {
    "topic": "DDL 前一晚课程汇报 PPT 还是空白",
    "title": "明早要讲的PPT还没动？先别熬了🙃",
    "body": (
        "是不是很熟悉：周日晚上十一点，小组群里终于有人问了一句，PPT 谁来做？\n\n"
        "然后就没人说话了。\n\n"
        "如果你正好是那个默默点开 PPT 的人，这篇写给你。\n\n"
        "我是在校大学生，平时接课程汇报的 PPT。你把老师的要求、讲稿或者大纲发我，"
        "我按页数、难度和截止时间报价。做完交可编辑的源文件，WPS 和 Office 都能直接打开，"
        "需要的话每页带演讲备注，上台照着讲就行。\n\n"
        "我会用 AI 提效，但交付前每一页都自己过一遍，文字溢出、配色打架、"
        "图表和数据对不上这些，都在发给你之前改掉。\n\n"
        "不下单也没关系，送你三个做汇报 PPT 最好用的小习惯：\n\n"
        "1. 一页只讲一件事，标题直接写结论，比如写「拖延不是懒，是不想开始」，"
        "而不是「原因分析」。\n\n"
        "2. 能画成图的数字就别堆成表格，老师扫一眼就能看懂。\n\n"
        "3. 正文字号别小于 18，坐在最后一排的人也要看得清。\n\n"
        "作业代写、论文代写不接，我只负责把你的内容做得清楚、好看。\n\n"
        "需要做 PPT 的，评论区留言或者私信我，告诉我主题、页数和什么时候要就行。"
    ),
    "tags": ["PPT制作", "课程汇报", "大学生", "小组作业", "PPT技巧", "期末周", "答辩PPT"],
    "cover": {
        "main": ["PPT还没动？", "今晚别再熬了"],
        "question": "明早就要上台讲了吗？",
        "small": ["课程汇报答辩都能做", "交付可编辑的源文件", "作业论文代写不接"],
    },
}
