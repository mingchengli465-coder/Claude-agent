...
- 可以接到 Telegram，也可以放进你自己的网站（网页右下角一个聊天窗口）
- 价格：国内商户一次性搭建 300-400 元，之后每月 99 元；海外商户一次性搭建 500-600 元人民币，之后每月 19.99 美元。
...
EXAMPLE_NOTE = {
    ...
    "body": (
        ...
        "价格说清楚：国内小店一次性搭建 300-400 元，之后每月 99 元，包含服务器、AI 用量和价目表更新，"
        "按月付，随时可以停。资料给齐后 2-3 天上线，可以接到 Telegram，也可以放进你自己的网站。\n\n"
    ...
    "cover": {
        "main": ["半夜来客问价", "AI替你秒回"],
        "question": "客人问完价格就没下文？",
        "small": ["按你的价目表自动回", "想买时第一时间通知你", "国内300起月费99"],
    },
}
